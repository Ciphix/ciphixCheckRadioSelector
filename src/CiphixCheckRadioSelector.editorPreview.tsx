...
export function preview(props: CiphixCheckRadioSelectorPreviewProps): ReactElement {
    const items = [props.linkedAssociation + ': #1',props.linkedAssociation + ': #2', props.linkedAssociation + ': #3'].map(item => {
    ...
    return <div className={props.orientation==="horizontal" ? "mx-radiobuttons inline" : "mx-radiobuttons"}>
        {items}
    </div>;
}
